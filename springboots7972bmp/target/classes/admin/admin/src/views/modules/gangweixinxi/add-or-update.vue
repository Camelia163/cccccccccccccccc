<template>
	<div class="addEdit-block">
		...
		>
			<template >
				<el-form-item class="input" v-if="type!='info'" label="岗位编号" prop="gangweibianhao" >
					<el-input v-model="ruleForm.gangweibianhao" placeholder="岗位编号" readonly></el-input>
				</el-form-item>
				<el-form-item class="input" v-else-if="ruleForm.gangweibianhao" label="岗位编号" prop="gangweibianhao" >
					<el-input v-model="ruleForm.gangweibianhao" placeholder="岗位编号" readonly></el-input>
				</el-form-item>
				...
				<el-form-item class="input" v-if="type!='info'"  label="时薪/小时" prop="shixin" >
					<el-input-number v-model="ruleForm.shixin" placeholder="时薪/小时" :disabled="ro.shixin"></el-input-number>
				</el-form-item>
				<el-form-item v-else class="input" label="时薪/小时" prop="shixin" >
					<el-input v-model="ruleForm.shixin" placeholder="时薪/小时" readonly></el-input>
				</el-form-item>
			...
			<el-form-item v-else-if="ruleForm.gangweiyaoqiu" label="岗位要求" prop="gangweiyaoqiu" >
				<span class="text ql-snow ql-editor" v-html="ruleForm.gangweiyaoqiu"></span>
			</el-form-item>
			...
			<el-form-item v-else-if="ruleForm.gangweijianjie" label="岗位简介" prop="gangweijianjie" >
				<span class="text ql-snow ql-editor" v-html="ruleForm.gangweijianjie"></span>
			</el-form-item>
			...
			info(id) {
				this.$http({
					...
					if (data && data.code === 0) {
						...
						this.ruleForm.gangweiyaoqiu = this.ruleForm.gangweiyaoqiu.replace(reg,'../../../springboots7972bmp/upload');
						this.ruleForm.gangweijianjie = this.ruleForm.gangweijianjie.replace(reg,'../../../springboots7972bmp/upload');
					} else {
						this.$message.error(data.msg);
					}
				});
